...
That frustration is why I made **Panel 060**. It does not press a template onto your image. It first works out what must not be lost, then translates it into **Distil a photograph into one to three black forms and a quiet visual philosophy that continues to resonate**.
