...
لهذا الإحباط صنعت **Panel 060**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **اختزال الصورة في شكل إلى ثلاثة أشكال سوداء وفلسفة بصرية هادئة يتردد صداها**.
