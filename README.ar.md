...
# 🦁 XXD Panel 060｜قصيدة زِن بسيطة

### اختزال الصورة في شكل إلى ثلاثة أشكال سوداء وفلسفة بصرية هادئة يتردد صداها
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092190049999937946"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 060 نموذج 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092190049999937946"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 060 نموذج 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092190049999937946"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 060 نموذج 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092190049999937946"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 060 نموذج 4"></a></td>
  </tr>
</table>

> خانة الوسائط الرابعة في المنشور الأصلي مطابقة للثالثة. يحتفظ المستودع بخانتي المرفق كما وردتا في المصدر، ولا يقدمهما بوصفهما تصميمين مختلفين.
...
<table>
  ...
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 060 نموذج 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 060 نموذج 8"></td>
  </tr>
</table>
...
<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092190049999937946">عرض منشور النماذج الأصلي ←</a></p>

تعرض هذه النماذج النتيجة الجمالية للإصدار 060 فقط؛ ولا تصبح موضوعاتها أو تكوينها أو ألوانها أو نصوصها أو نسبة اللوحة السابقة مراجع أو إعدادات افتراضية لمهمة جديدة.
...
يناسب **Panel 060** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **اختزال الصورة في شكل إلى ثلاثة أشكال سوداء وفلسفة بصرية هادئة يتردد صداها**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.
...
> استخدم XXD Panel 060 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
شكل أسود رئيسي · فراغ هائل · تلاشي هالف تون · تأمل زِنّي · شظايا فكر

يختزل الصورة في شكل واحد هو الأهم، وعلاقة واحدة جديرة بالتذكّر، وقضية بصرية واحدة ذات معنى. يظهر الموضوع الأسود ويختفي في الوقت نفسه عبر الهالف تون والخطوط والموجات والحبيبات والتلاشي، بينما يجعل الورق شديد الفتوح والفراغ الهائل الهدوء والوحدة والزمن وفعل النظر نفسه مضمون الصورة.

<!-- xxd-panel-benefit:start -->
## تحقق سريع: هل XXD Panel 060 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | اختزال الصورة في شكل إلى ثلاثة أشكال سوداء وفلسفة بصرية هادئة يتردد صداها |
| **السمات التي تُعرف من النظرة الأولى** | شكل أسود رئيسي · فراغ هائل · تلاشي هالف تون · تأمل زِنّي · شظايا فكر |
...
يحدد الأسلوب الموضوع والهيئة والوضع والعلاقة المكانية والاستعارة العاطفية الأكثر قابلية للتعرّف، ثم يتخلى عمداً عن المشهد الكامل. لا يبقي سوى شكل أساسي وعلاقة وقضية بصرية، فيظل مصدر العنصر محسوساً وتصبح قراءات الهدوء والوحدة والزمن والنظر والوجود أعمق.

```text
تثبيت الهوية والهيئة والوضع والعلاقة المكانية ← قراءة المعنى الضمني وقضية الوجود ← حذف المشهد الكامل والتفاصيل الواقعية ← الاختزال في شكل إلى ثلاثة أشكال سوداء أساسية ← صنع الظهور／الاختفاء بالهالف تون والشبكات والموجات والحبيبات والإزاحة والتلاشي ← بناء الروحانية بورق شديد الفتوح وفراغ هائل ← دمج تعليق أو ملاحظة مفاهيمية أو شظية فكر
```

## سمات الأسلوب التي تظهر بوضوح في النتيجة

- يبقى عادةً شكل مركزي واحد إلى ثلاثة؛ ويأتي المحيط أو الظل أو التموج أو الجبل أو الدائرة أو العين أو المسار أو الحد المكسور من المعنى الضمني للأصل.
- الأسود هو البطل المطلق، وتتكون الأشكال عبر الهالف تون والشبكات والخطوط والموجات والحبيبات والإزاحة والتكرار والتخفيف والتشويه الموضعي.
- قد تبقى الحدود واضحة أو ترتخي وتضبب وتنقطع تدريجياً، فيتعايش الظهور والاختفاء.
- تمنح خلفيات العاجي والرمادي الضبابي والمغرة الفاتحة والرمادي الوردي والأزرق الرمادي شديد الفتوح الفراغ روحانية وتنفساً.
- يمكن تعليق الموضوع أو إزاحته أو خفضه أو رفعه أو تصغيره؛ ويعمل النص القليل كتعليق أو شظية فكر لا كتفسير.

لا توجد القيود الجمالية وقواعد الرفض إلا في [الموجّه الأصلي](references/original-prompt/zh-CN.md)، أما المهارة ومهايئ التشغيل فيعالجان متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-060-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 060. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-060 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-060 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-060 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-060 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-060 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 060 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-060 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-060`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-060-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-060-prompt.zh-CN.md)
