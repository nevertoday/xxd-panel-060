...
# 🦁 XXD Panel 060｜禅のミニマル詩

### 写真を1〜3個の黒い核へ凝縮し、静かに余韻を残す視覚哲学へ
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092190049999937946"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 060 作例 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092190049999937946"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 060 作例 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092190049999937946"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 060 作例 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092190049999937946"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 060 作例 4"></a></td>
  </tr>
</table>

> 元の投稿では4番目のメディア枠が3番目と同一です。リポジトリは両方の添付枠を忠実に残していますが、別々のデザインとしては扱いません。
...
<table>
  ...
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 060 作例 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 060 作例 8"></td>
  </tr>
</table>

## 3:4 縦長・上下構成の作例

16:9 組とは別の独立した4点で、3:4 上下の完成キャンバスを生成。上部は現実の写真を保ち、下部は Panel 060 の原文プロンプトに従って再構成しています。英語コピーは各写真の内容・空気・含意だけから生成し、全点を個別に確認しました。

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 060 追加上下作例 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 060 追加上下作例 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 060 追加上下作例 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 060 追加上下作例 4"></td>
  </tr>
</table>

> [小小東（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2092190049999937946) · 2026年8月25日<br>
> GPT2 × 禅意 × ミニマリズム × 美学プロンプト × VOL.060

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092190049999937946">元の作例投稿を見る →</a></p>

これらの作例は 060 の美的成果だけを示します。作例の被写体、構図、配色、文字、旧キャンバス比率が、新しいタスクの参照や既定値になることはありません。
...
**Panel 060** は、原写真の核を保ちながら、次の視覚方向を目指す制作に向いています：**写真を1〜3個の黒い核へ凝縮し、静かに余韻を残す視覚哲学へ**。まず用途と期待する結果を確認し、そこから構図、サイズ、文字、納品形式を決めます。
...
簡体字中国語ファイルは小小東の文言を逐語で保存し、実行時の唯一の美的基準です。他の4言語は海外の読者が読み、共有するための忠実な翻訳であり、生画像プロンプトを書き換えません。

黒い主形 · 巨大な余白 · 網点の消散 · 禅的思考 · 思考の断片
...
画像フォルダーを直接渡すと、この兵士 Skill が同じ Panel 060 の原文美学で一括処理します。一般的なラスター形式を既定で再帰検索し、件数を報告してから、モード・サイズ・文字・言語を一度だけ確認します。各画像は内容や文言を混ぜず独立生成し、バッチ全体は一つのフラットなタスクフォルダーへ保存します。個別の失敗は記録し、後続画像を黙って省略しません。
...
/xxd-panel-060 photo.jpg --mode top-bottom --size auto --text prompt --locale ja-JP
...
/xxd-panel-060 photo.jpg --mode design-only --size 3:4 --text prompt --locale ja-JP

# 正確な文言を、書き換え・翻訳・タイトル追加なしで使用
/xxd-panel-060 photo.jpg --mode design-only --size 3:4 --copy "光をここに残す" --locale ja-JP

# 2モード × 3サイズで独立した完成構図を6枚生成
/xxd-panel-060 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ja-JP

# フォルダー全体へ Panel 060 を適用し、共通設定は一度だけ解決
/xxd-panel-060 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ja-JP
